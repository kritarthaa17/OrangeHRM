class PIM {
    ...
    supervisorName() {
        return cy.get(':nth-child(5) > .oxd-input-group > :nth-child(2) > .oxd-autocomplete-wrapper > .oxd-autocomplete-text-input > input').type('j').get('.oxd-autocomplete-dropdown > :nth-child(1) > span').click()
     
    }
    jobTitle(){
        return cy.get(':nth-child(6) > .oxd-input-group > :nth-child(2) > .oxd-select-wrapper > .oxd-select-text').click().get('.oxd-select-dropdown > :nth-child(2) > span').click()
    }
